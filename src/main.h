...
static const int64 MAX_MONEY = 2100000000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250; // 720 blocks found a day. Priority cutoff is 1 PIG day / 250 bytes.
    }
